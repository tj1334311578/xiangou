    ...
    private void initView() {
        ...
        findonepager_number.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length()==11){
                    findonepager_next.setBackground(getResources().getDrawable(R.drawable.round20dp));
                    findonepager_next.setOnClickListener(FindonepagerActivity.this);
                }else{
                    findonepager_next.setBackground(getResources().getDrawable(R.drawable.unround20dp));
                }
            }
        });
    }
