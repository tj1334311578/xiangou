...
public class DashedLine extends View {
    ...
    public DashedLine(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        this. paint.setStrokeWidth(ContextUtils.dp2px(2));
        float[] arrayOfFloat = new float[4];
        arrayOfFloat[0] = ContextUtils. dp2px(2);
        arrayOfFloat[1] = ContextUtils. dp2px(2);
        arrayOfFloat[2] = ContextUtils. dp2px(2);
        arrayOfFloat[3] = ContextUtils. dp2px(2);
        this. pe = new DashPathEffect(arrayOfFloat, ContextUtils.dp2px(1));
    }
