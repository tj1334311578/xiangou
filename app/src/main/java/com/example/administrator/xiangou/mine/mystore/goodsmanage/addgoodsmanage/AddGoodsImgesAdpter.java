 ...
 */
public class AddGoodsImgesAdpter extends BaseAdapter {
    ...
    public AddGoodsImgesAdpter(Context context, List<Map<String, Object>> datas) {
        this.datas = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView=inflater.inflate(R.layout.item_addgoodspic_gride,parent,false);
        ...
        if (datas!=null && position<datas.size()){
            ...
            Glide.with(context)
                    .load(R.mipmap.advice_feedback_add_img)
                    .priority(Priority.HIGH)
                    .centerCrop()
                    .into(viewHolder.ivimage);
    ...
    public class ViewHolder{
        ...
        public ViewHolder(View root) {
            ivimage = (ImageView) root.findViewById(R.id.addgoodspic_iv_image);
            btdel = (Button) root.findViewById(R.id.addgoodspic_bt_del);
            this.root = root;
        }
    }
}
