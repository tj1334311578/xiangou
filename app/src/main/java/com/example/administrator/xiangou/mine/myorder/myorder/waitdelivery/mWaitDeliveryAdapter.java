...
//        evaluate.setText("确定收货");
    ...
    private void initLocationView(int position) {
        ...
        mrecycle.setAdapter(new EvaluationAdapter(mcontext,lists.get(position).getList()));
    }
    ...
    private class EvaluationAdapter extends AutoRVAdapter {
