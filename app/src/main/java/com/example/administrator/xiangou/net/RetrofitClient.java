...
public class RetrofitClient {
    ...
    public static String baseUrl = XianGouApiService.mBASEURL;
   ...
   private RetrofitClient() {
    ...
    private RetrofitClient(Context context, String url, Map<String, String> headers) {
        ...
        if ( httpCacheDirectory == null) {
            httpCacheDirectory = new File( ContextUtils.getInstance().getCacheDir(), "tamic_cache");
        }
   ...
   /**
    ...
    public static void addCookie() {
        okHttpClient.newBuilder().cookieJar(new NovateCookieManger(ContextUtils.getInstance())).build();
...
//    }
     ...
     * For example:
     *  XianGouApiService service =
     *      RetrofitClient.getInstance(MainActivity.this).create(XianGouApiService.class);
     *
