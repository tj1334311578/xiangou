...
//                upData();
    ...
    //设置样式2
    private void style2() {
        condition.setTextColor(mContext.getResources().getColor(R.color.whiteBgColor));
        ...
        preferentialvalue.setTextColor(mContext.getResources().getColor(R.color.whiteBgColor));
