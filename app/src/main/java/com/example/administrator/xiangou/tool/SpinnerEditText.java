...
public class SpinnerEditText<T> extends AppCompatEditText {
    ...
    private void initDefaultRightIcon() {
        ...
        int paddingleft = this.dp2px(context, 5);
        int paddingright = this.dp2px(context, 10);
    ...
    private void initOrUpdateListPopupWindow() {
        if (listPopupWindow == null) {
            ...
            adapter = new ArrayAdapter<>(context, android.R.layout.simple_spinner_item, realShowItemList);
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_UP:
                ...
                if (mRightListener != null && event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    rect.left = rect.right - this.dp2px(context, 50);
